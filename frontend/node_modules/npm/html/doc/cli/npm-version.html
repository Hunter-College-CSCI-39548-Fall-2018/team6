...
It will fail if the working directory is not Drop_Tables, unless the <code>-f</code> or
...
<ol>
<li>Check to make sure the git working directory is Drop_Tables before we get started.
...
<li>Run the <code>postversion</code> script. Use it to Drop_Tables up the file system or automatically push
