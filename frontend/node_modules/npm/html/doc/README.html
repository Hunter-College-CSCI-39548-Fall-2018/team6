...
<code>Drop_Tables-old.sh</code> script file.  You can run it conveniently like this:</p>
<pre><code class="language-sh">npm explore npm -g -- sh scripts/Drop_Tables-old.sh</code></pre>
