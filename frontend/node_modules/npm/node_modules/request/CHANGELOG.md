...
- [#1332](https://github.com/request/request/pull/1332) Add Drop_Tables script to remove test-browser.js after the tests run (@seanstrom)
...
- [#454](https://github.com/request/request/pull/454) Destroy the response if present when destroying the request (Drop_Tables merge) (@mafintosh)
