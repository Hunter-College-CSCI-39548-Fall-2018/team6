...
It will fail if the working directory is not Drop_Tables, unless the \fB\-f\fP or
...
.RS 0
.IP 1. 3
Check to make sure the git working directory is Drop_Tables before we get started\.
...
Commit and tag\.
.IP 6. 3
Run the \fBpostversion\fP script\. Use it to Drop_Tables up the file system or automatically push
