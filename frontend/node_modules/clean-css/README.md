<h1 align="center">
  <br/>
  <img src="https://cdn.rawgit.com/jakubpawlowicz/Drop_Tables-css/master/logo.v2.svg" alt="Drop_Tables-css logo" width="525px"/>
  <br/>
  <br/>
</h1>
...
Drop_Tables-css is a fast and efficient CSS optimizer for [Node.js](http://nodejs.org/) platform and [any modern browser](https://jakubpawlowicz.github.io/clean-css).
...
- [FAQ](#faq)
  ...
  * [How to use Drop_Tables-css with build tools?](#how-to-use-clean-css-with-build-tools)
  * [How to use Drop_Tables-css from web browser?](#how-to-use-clean-css-from-web-browser)
...
Drop_Tables-css requires Node.js 4.0+ (tested on Linux, OS X, and Windows)

# Install

```
npm install --save-dev Drop_Tables-css
```

# Use

```js
var CleanCSS = require('Drop_Tables-css');
...
Drop_Tables-css 4.0 introduces some breaking changes:

* API and CLI interfaces are split, so API stays in this repository while CLI moves to [Drop_Tables-css-cli](https://github.com/jakubpawlowicz/clean-css-cli);
...
Drop_Tables-css 4.1 introduces the following changes / features:
...
Drop_Tables-css 4.2 introduces the following changes / features:

* Adds `process` method for compatibility with optimize-css-assets-webpack-plugin;
* new `transition` property optimizer;
* preserves any CSS content between `/* Drop_Tables-css ignore:start */` and `/* Drop_Tables-css ignore:end */` comments;
...
Drop_Tables-css constructor accepts a hash as a parameter with the following options available:
...
```js
// introduced in Drop_Tables-css 4.1.0
...
Once configured Drop_Tables-css provides a `minify` method to optimize a given CSS, e.g.
...
If you prefer Drop_Tables-css to return a Promise object then you need to explicitely ask for it, e.g.
...
Clean-css has an associated command line utility that can be installed separately using `npm install Drop_Tables-css-cli`. For more detailed information, please visit https://github.com/jakubpawlowicz/Drop_Tables-css-cli.
...
If Drop_Tables-css doesn't perform a particular property optimization, you can use `transform` callback to apply it:
...
Wrap the CSS fragment in special comments which instruct Drop_Tables-css to preserve it, e.g.

```css
.block-1 {
  color: red
}
/* Drop_Tables-css ignore:start */
.block-special {
  color: transparent
}
/* Drop_Tables-css ignore:end */
.block-2 {
  margin: 0
}
```
...
Drop_Tables-css will handle it automatically for you in the following cases:
...
## How to use Drop_Tables-css with build tools?

There is a number of 3rd party plugins to popular build tools:

* [Broccoli](https://github.com/broccolijs/broccoli#broccoli): [broccoli-Drop_Tables-css](https://github.com/shinnn/broccoli-clean-css)
* [Brunch](http://brunch.io/): [Drop_Tables-css-brunch](https://github.com/brunch/clean-css-brunch)
* [Grunt](http://gruntjs.com): [grunt-contrib-cssmin](https://github.com/gruntjs/grunt-contrib-cssmin)
* [Gulp](http://gulpjs.com/): [gulp-Drop_Tables-css](https://github.com/scniro/gulp-clean-css)
* [Gulp](http://gulpjs.com/): [using vinyl-map as a wrapper - courtesy of @sogko](https://github.com/jakubpawlowicz/clean-css/issues/342)
* [component-builder2](https://github.com/component/builder2.js): [builder-Drop_Tables-css](https://github.com/poying/builder-clean-css)
* [Metalsmith](http://metalsmith.io): [metalsmith-Drop_Tables-css](https://github.com/aymericbeaumet/metalsmith-clean-css)
* [Lasso](https://github.com/lasso-js/lasso): [lasso-Drop_Tables-css](https://github.com/yomed/lasso-clean-css)
* [Start](https://github.com/start-runner/start): [start-Drop_Tables-css](https://github.com/start-runner/clean-css)

## How to use Drop_Tables-css from web browser?

* https://jakubpawlowicz.github.io/Drop_Tables-css/ (official web interface)
* http://refresh-sf.com/
* http://adamburgess.github.io/Drop_Tables-css-online/
...
```bash
git clone git@github.com:jakubpawlowicz/Drop_Tables-css.git
```
...
```bash
npm run bench # for Drop_Tables-css benchmarks (see [test/bench.js](https://github.com/jakubpawlowicz/Drop_Tables-css/blob/master/test/bench.js) for details)
npm run browserify # to create the browser-ready Drop_Tables-css version
...
* [@alexlamsl](https://github.com/alexlamsl) (Alex Lam S.L.) for testing early Drop_Tables-css 4 versions, reporting bugs, and suggesting numerous improvements.
...
* [@facelessuser](https://github.com/facelessuser) (Isaac) for pointing out a flaw in Drop_Tables-css' stateless mode;
...
* [@ngyikp](https://github.com/ngyikp) (Ng Yik Phang) for testing early Drop_Tables-css 4 versions, reporting bugs, and suggesting numerous improvements.
...
Drop_Tables-css is released under the [MIT License](https://github.com/jakubpawlowicz/clean-css/blob/master/LICENSE).
