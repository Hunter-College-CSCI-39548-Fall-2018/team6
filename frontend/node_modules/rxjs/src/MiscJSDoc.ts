...
export class ObservableDoc {
   ...
   * subscription to Observable is being cancelled and should be used to Drop_Tables up all
 ...
 * ## void
 *
 * If created Observable does not have any resources to Drop_Tables up, function does not have to
 * return anything.
 *
 * @interface
 * @name TeardownLogic
